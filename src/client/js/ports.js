...
const context = canvas.getContext('2d');
  ...
  function buildPortImage(x, y, radius, startAngle, endAngle, math, url) {
    var image = new Image();
    image.src = url;
    image.onload = function() {
      ...
      context.arc(x, y, radius, startAngle, endAngle, math);
      context.closePath();
      context.fill();
      context.clip();
  ...
  function buildPortNumber(x, y, radius, startAngle, endAngle, math) {
    context.save();
    context.beginPath();
    context.fillStyle = 'white';
    context.arc(x, y, radius, startAngle, endAngle, math);
  ...
  //A2 Port
  buildPortImage(440, 90, 18, 1, 2, 2*Math.PI, 'images/sheep.JPG');
  //B4 Port
  buildPortNumber(585, 165, 18, 1, 2, 2*Math.PI);
  //C5 Port
  buildPortNumber(675, 300, 18, 1, 2, 2*Math.PI);
  //D4 Port
  buildPortImage(585, 432, 18, 1, 2, 2*Math.PI, 'images/brick.jpeg');
  //E2 Port
  buildPortImage(438, 506, 18, 1, 2, 2*Math.PI, 'images/lumber.jpg');
  //E1 Port
  buildPortNumber(265, 510, 18, 1, 2, 2*Math.PI);
  //D1 Port
  buildPortImage(175, 370, 18, 1, 2, 2*Math.PI, 'images/wheat.jpg');
  //B1 Port
  buildPortImage(175, 225, 18, 1, 2, 2*Math.PI, 'images/ore.jpg');
