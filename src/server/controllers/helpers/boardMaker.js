const randomTile = ['wood', 'wood', 'wood', 'wood', 'wheat', 'wheat', 'wheat', 'wheat', 'sheep', 'sheep', 'sheep', 'sheep', 'brick', 'brick', 'brick', 'ore', 'ore', 'ore', 'desert'];
...
class Board {
  constructor(random =  false) {
    ...
    this.three = random ? __getRandomTile() : {type: 'wood', roll: 9};
    ...
    this.nine = random ? __getRandomTile() : {type: 'wood', roll: 11};
    this.ten = random ? __getRandomTile() : {type: 'desert', roll: null};
    this.eleven = random ? __getRandomTile() : {type: 'wood', roll: 3};
    this.twelve = random ? __getRandomTile() : {type: 'ore', roll: 8};
    this.thirteen = random ? __getRandomTile() : {type: 'wood', roll: 8};
